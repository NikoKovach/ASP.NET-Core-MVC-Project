...
$("#search-by-company-btn").on("click", function () {
	selectedCompanyId = $("#selectCompany").val();
...
function setContractFields(contract) {
	$("#jobTitle").val(contract["jobTitle"]);
	$("#departmentName").val(contract["departmentName"]);
...
/*		alert(tempDate.toLocaleDateString('bg-BG',{ dateStyle: 'short' }));*/
    ...
    "itemsCollection": [
        {
            ...
            "contractInfo": {
                ...
                "contractDate": "2024-06-10T00:00:00", "contractDate": null,
                "agreementsCount": 1
            },
            "experience": null
        }
