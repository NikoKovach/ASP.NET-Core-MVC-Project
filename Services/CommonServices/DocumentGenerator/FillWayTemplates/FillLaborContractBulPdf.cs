...
namespace LegalFramework.Services.DocumentGenerator.FillWayTemplates
{
    public class FillLaborContractBulPdf : IFill
    {
        ...
        {
            Dictionary<string, Paragraph> section = document.SectionsDictionary["laborMainSection"];
        ...
        private void FillPartOnePointTwo( Paragraph paragraph )
        {
            ...
            this.sb.Replace( "<<WorkTimeInWords>>",
                              FillUtilities
                              .TheNumberInWords( this.agreement.WorkTime, "number", "bg-BG" ) );

            this.sb.Replace( "<<Salary>>", FillUtilities.NewValue( this.agreement.Salary ) );

            this.sb.Replace( "<<SalaryInWords>>",
                              FillUtilities
                              .TheNumberInWords( this.agreement.Salary, "currency", "bg-BG" ) );
