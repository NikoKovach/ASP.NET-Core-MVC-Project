...
//{
//       public class zzzPagingBaseList<T>
//       {
//              public zzzPagingBaseList( List<T> items, int maxTotalPagest, int pageIndex, int pageSize )
//              {
...
//              public static async Task<zzzPagingBaseList<T>> CreateCollectionAsync
...
//                     return new zzzPagingBaseList<T>( items, totalPages, validPageIndex, pageSize ?? 1 );
//              }
